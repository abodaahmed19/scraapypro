...
export default defineComponent({
  ...
  methods: {
    ...
    async fetchDocuments(
      ...
      try {
        console.log('API For Search: ', 'https://vmi2584358.contaboserver.net/api/document/user-documents/', { params })
        const response = await this.$axios.get('https://vmi2584358.contaboserver.net/api/document/user-documents/', { params })
        console.log('API For Search: ', 'https://vmi2584358.contaboserver.net/api/document/user-documents/', { params })
