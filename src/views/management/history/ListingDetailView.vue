  ...
  methods: {
    ...
    async updateTracking() {
      try {
        ...
        const response = await this.$axios.post(
          `https://vmi2584358.contaboserver.net/api/billing/orders/${this.orderDetails.orderId}/`,
          {
    ...
    async uploadeReport(file: File) {
      try {
        ...
        const response = await this.$axios.post(
          `https://vmi2584358.contaboserver.net/api/billing/orderitem/report/${this.orderDetails.orderItemId}/`,
          formData,
          {
            headers: {
