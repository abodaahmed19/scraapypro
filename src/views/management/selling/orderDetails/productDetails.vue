...
export default defineComponent({
  ...
  data() {
   ...
   PickupAddress: [
  {
    value: this.$props.orderDetails.deliveryAddress || 'Non spécifié',
    iconUrl: shallowRef(location),
    parentClass: 'box_text'
  },
  {
    value: this.$props.orderDetails.deliveryCity || 'Non spécifié',
    iconUrl: shallowRef(globalLocation),
    parentClass: 'box_text'
  },
  {
    value: this.$props.orderDetails.deliveryContactName || 'Non spécifié',
    iconUrl: shallowRef(userIcon),
    parentClass: 'box_text'
  },
  {
    value: this.$props.orderDetails.deliveryPhone || 'Non spécifié',
