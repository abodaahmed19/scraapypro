...
export default defineComponent({
  ...
  methods: {
    async fetchApi() {
      try {
        const response = await this.$axios.get<User[]>('https://vmi2584358.contaboserver.net/api/users/staff/')
    ...
    async approveVendor(commercialRegistration: string | undefined) {
      ...
      try {
        await this.$axios.post(`https://vmi2584358.contaboserver.net/api/users/staff/${commercialRegistration}/approve/`)
    ...
    async rejectVendor(commercialRegistration: string | undefined) {
      ...
      try {
        await this.$axios.post(`https://vmi2584358.contaboserver.net/api/users/staff/${commercialRegistration}/reject/`)
