...
export default defineComponent({
  ...
  data() {
    return {
      ...
      nextPageUrl: 'https://vmi2584358.contaboserver.net/api/driver/create/' as string | null,
  ...
  methods: {
    ...
    async generatePassword(itemID: number | string) {
      try {
        ...
        const response = await this.$axios.post(`https://vmi2584358.contaboserver.net/api/driver/renew-password/`, { pk: itemID })
